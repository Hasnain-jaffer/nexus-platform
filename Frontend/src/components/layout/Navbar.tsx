/**
 * Navbar.tsx — Updated in Step 4
 *
 * Changes:
 *  - Live unread message count badge via socket "new_message" event
 *  - Live unread notification count badge via socket "new_notification" event
 *  - Both badges clear when the user visits the relevant page
 */
...
export const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleNewMessage = () => {
      // Only increment if user is NOT already on the chat page
    ...
    const handleNewNotification = () => {
      // Only increment if user is NOT on notifications page
